...
suite('install Tools tests', () => {
  ...
  test('getPlatformSpecificNodeLink', () => {
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'win32', 'x32'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-win-x86.zip");
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'win32', 'x64'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-win-x64.zip");
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'win32', 'arm64'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-win-arm64.zip");
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'darwin', 'x64'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-darwin-x64.tar.gz");
    ...
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'linux', 'x64'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-linux-x64.tar.gz");
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'linux', 'arm'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-linux-armv7l.tar.gz");
    expect(getPlatformSpecificNodeLink(latestNodeHTML, 'linux', 'arm64'))
      .to.equal("/dist/v20.20.2/node-v20.20.2-linux-arm64.tar.gz");
  });
